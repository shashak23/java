...
public class ArrayListTest {
	...
	{
		//ArrayList 하나를 생성해보자.
		ArrayList<Object> a = new ArrayList();  //컨트롤+shift+o(영어) 하면 자동으로 생성됨.
		...
		a.add(new Integer(100));        //숫자인 100을 넣고 싶다면, 그냥 100이 아니고 Error는 아니지만
		                                //in t 100에 대응하는Integer Class의 100을 넣는다. Integer(100)
		...
		//위의 코드들의 in t를 없애려면 어떻게 해야할까? type - Object로 잡아야하고 <>사용 : <Object>
		//정수는 Object로부터 상속받았으니까 type도 Object에서 받음 why? IS - A 관계니까~!
		
		ArrayList b = new ArrayList();  //노란색 밑줄은 여기서 더 정석대로 하라는 말....
		ArrayList<String> b1 = new ArrayList(); // 문자열만 집어 넣는다?! -> <> 사용
		b1.add("Hello");
		b1.add("홍길동");                    //Heap에 String pool에서 사용
		b1.add(new String("소리없는 아우성!"));  //Heap에 ArrayList에서 사용
		b1.add(100, null); //in t가 들어올 수 없기에 error로 됨
